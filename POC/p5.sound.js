...
master = function (audiocontext) {
   ...
   *  and Gain Node for <code>.input</code> and <code>.output</code>.
   *
...
eq = function () {
   ...
   * built using a chain of Web Audio Biquad Filter Node and can be
...
delay = function () {
  ...
  p5.Delay = function () {
     ...
     *  Web Audio Delay Node</a>, one for each stereo channel.
     *
...
audioVoice = function () {
  ...
  /**
   * Connect to p5 objects or Web Audio Node
   * @method  connect
   * @param {Object} unit
   */
